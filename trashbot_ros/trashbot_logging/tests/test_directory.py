...
""" Python unittest script for trashbot_logging/directory module.
...
PKG='trashbot_logging'
import os
import stat
import unittest

# module under test:
from trashbot_logging.directory import *
...
class TestLoggingDirectory(unittest.TestCase):
    ...
    def test_using_no_parameters(self):
        ...
        d = home + '/.ros/trashbot/trashbot_logging'
